...
const Home = () => {
  ...
  return (
    <div className={"mt-10 w-full h-full flex flex-row justify-between bg-blue-50"}>
      <div className={"w-1/2 flex flex-col justify-between"}>
        <h2 className={"ml-10 mt-10 mb-5 text-xl"}>East Zone Lead</h2>
        <div
          className={
            "h-80 ml-10 mb-10 w-full px-10 py-5 shadow-md rounded-2xl bg-white"
          }
        >
          <div className={"h-16 flex flex-row justify-between"}>
            <div className={"flex flex-col justify-between"}>
              <h1 className={"font-semibold mb-5"}>Today's chart (30 May 2021)</h1>
              <div className={"flex flex-row"}>
                <div className="flex items-center mr-10">
                  ...
                  <label
                    ...
                    className="ms-2 text-sm font-medium text-orange-400"
                  >
                    Forecast
                  </label>
                </div>
                <div className="flex items-center mr-10">
                  ...
                  <label
                    htmlFor="disabled-radio-1"
                    className="ms-2 text-sm font-medium text-teal-400"
                  >
                    Actual
                  </label>
                </div>
                <div className="flex items-center">
                  ...
                  <label
                    htmlFor="disabled-radio-1"
                    className="ms-2 text-sm font-medium text-black-200"
                  >
                    Both
                  </label>
                </div>
        ...
        <div
          className={"h-72 w-full ml-10 mb-10 shadow-md rounded-2xl bg-white"}
        >
