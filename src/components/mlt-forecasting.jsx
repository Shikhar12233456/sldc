...
const MltForecasting = () => (
    <div className={'pt-20 px-5 p-5 w-[100vw] h-[100vh] bg-blue-100 flex flex-col justify-between'}>
        <div className={'w-full h-[42vh] flex flex-row justify-between'}>
        ...
        <div className={'w-full h-[42vh] rounded-2xl bg-white flex flex-col'}>
            <div className={'my-4 mx-6 flex flex-row justify-between'}>
